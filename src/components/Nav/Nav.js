      ...
      >
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          ...
          <div className="flex md:order-2">
            <button
              type="button"
              className="text-white bg-[#2AC18C] hover:bg-[#166549] focus:ring-0 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-[#166549] dark:focus:ring-blue-800"
            >
              {user ? (
